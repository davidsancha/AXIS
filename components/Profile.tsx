...
const Profile: React.FC<ProfileProps> = ({ onAdminClick }) => {
  ...
  return (
    <div className="flex-1 overflow-hidden bg-background-dark">
      <main className="h-full overflow-y-auto pb-32 no-scrollbar">
        <header className="px-4 py-3 bg-background-dark/95 backdrop-blur-md border-b border-white/5 flex items-center justify-between">
